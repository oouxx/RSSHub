...
// 淘股吧论坛
// router.get('/taoguba/fangfalun', lazyloadRouteHandler('./routes/taoguba/fangfalun'));
// router.get('/taoguba/geguyanjiu', lazyloadRouteHandler('./routes/taoguba/bbs'));
// router.get('/taoguba/other', lazyloadRouteHandler('./routes/taoguba/other'));
// router.get('/taoguba/wangyoujingxuan', lazyloadRouteHandler('./routes/taoguba/wangyoujingxuan'));
// router.get('/taoguba/jiahong', lazyloadRouteHandler('./routes/taoguba/newsjiahong'));
// router.get('/taoguba/recommend', lazyloadRouteHandler('./routes/taoguba/recommend'));
// router.get('/taoguba/user/:uid', lazyloadRouteHandler('./routes/taoguba/user'));
// router.get('/taoguba/reply/:uid', lazyloadRouteHandler('./routes/taoguba/reply'));

// 韭研公社
// router.get('/jiuyangongshe/user/:uid', lazyloadRouteHandler('./routes/jiuyangongshe/user'));
// router.get('/jiuyangongshe/index', lazyloadRouteHandler('./routes/jiuyangongshe/index'));
// router.get('/jiuyangongshe/action', lazyloadRouteHandler('./routes/jiuyangongshe/action'));
...
router.get('/91porny/latest', lazyloadRouteHandler('./routes/91porny/latest'));
router.get('/91porny/ori', lazyloadRouteHandler('./routes/91porny/ori'));
...
// 生意社
router.get('/100ppi/index', lazyloadRouteHandler('./routes/100ppi/index'));
